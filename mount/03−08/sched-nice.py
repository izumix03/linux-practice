...
def usage():
    print("""使い方: {} <nice値>
    * 論理CPU0上で100ミリ秒程度CPUリソースを消費する負荷処理を2つ起動した後に、両 方のプロセスの終了を待つ。
...
# このプログラムの実行に時間がかかりすぎるような場合は値を小さくしてください。 # 反対にすぐ終わってしまうような場合は値を大きくしてください。
...
# 論理CPU0上での実行を強制 os.sched_setaffinity(0, {0})
